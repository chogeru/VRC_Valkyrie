...
namespace MalbersAnimations.IK
{
    ...
    // [Unity.Cinemachine.SaveDuringPlay] - Cinemachine 3.x-only editor convenience
    // attribute (keeps values live-edited in Play Mode). This project's VRChat
    // SDK pins Cinemachine 2.9.7 (namespace `Cinemachine`, no SaveDuringPlay
    // attribute), so it's disabled rather than left as a hard compile error.
